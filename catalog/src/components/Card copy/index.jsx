  ...
  return (
    <div className="relative rounded-md bg-gray-50 h-80 w-56 md:h-[40rem] md:w-96 overflow-hidden flex flex-col items-start justify-start">
      ...
      <div className=" z-40 flex flex-col justify-between items-start">
        <p className="absolute top-9 left-9 bg-skin-button-acent px-3 rounded-md py-2  text-sm md:text-base font-medium font-sans text-left">
          categoria
        </p>
        <div className=" absolute bottom-9 left-9 flex flex-col justify-end">
